...
function StickyHeadTable(props) {
  ...
  useEffect(() => {
       if(sessionStorage.getItem("access_token")){
          axios.get(props.baseUrl+'/events').then(response => setPosts(response.data))
...
class Events extends Component{
    ...
    render() {
            ...
            <div>
                ...
                <Menu menulink="events" props={this.props}/>
                ...
                <ModalDialog type="events" open={this.state.modalIsOpen} handleClose={this.closeModal} baseUrl={this.props.baseUrl}/>
            </div>
               )
    }
}
